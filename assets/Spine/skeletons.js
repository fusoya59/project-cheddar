...
assets.spine.spineBoy = assets.spine.spineBoy || {};
...
assets.spine.spineBoy.skeleton = {
    "bones": [
        { "name": "root" },
...
assets.spine.spearWarrior = assets.spine.spearWarrior || {};
assets.spine.spearWarrior.atlas =
    '\r\n' +
...
assets.spine.spearWarrior.skeleton = {
    "bones": [
        { "name": "root", "y": 1.16 },
        { "name": "cog", "parent": "root", "y": -1.16 },
        { "name": "Pelvis", "parent": "cog", "length": 5, "x": -0.12, "y": 1.56, "rotation": -89.6 },
        { "name": "Spine", "parent": "cog", "length": 15.65, "x": -0.36, "y": 2.39, "rotation": 90 },
        { "name": "Head", "parent": "Spine", "length": 57.42, "x": 13.05, "rotation": 0.45 },
        { "name": "Kilt", "parent": "Pelvis", "x": 1.56, "y": 0.11 },
        { "name": "L_Leg", "parent": "Pelvis", "length": 12.19, "x": 6.74, "y": 4.29, "rotation": -3.36 },
        { "name": "L_Shoulder", "parent": "Spine", "length": 10.69, "x": 12.65, "y": -11.08, "rotation": -147.52 },
        { "name": "R_Leg", "parent": "Pelvis", "length": 12.19, "x": 6.69, "y": -4.28, "rotation": -3.36 },
        { "name": "R_Shoulder", "parent": "Spine", "length": 6.48, "x": 12.17, "y": 10.44, "rotation": 162.93 },
        { "name": "L_Elbow", "parent": "L_Shoulder", "length": 6.78, "x": 8.36, "y": 0.9, "rotation": -48.48 },
        { "name": "R_Elbow", "parent": "R_Shoulder", "length": 7.78, "x": 9.64, "y": -1.1, "rotation": -45.49 },
        { "name": "L_Hand", "parent": "L_Elbow", "length": 6.98, "x": 7.53, "y": -0.34, "rotation": -21.48 },
        { "name": "R_Hand", "parent": "R_Elbow", "length": 6.48, "x": 7.75, "y": 0.03, "rotation": -128.76 }
    ],
    "slots": [
        { "name": "leftLeg", "bone": "L_Leg", "attachment": "leg" },
        { "name": "rightLeg", "bone": "R_Leg", "attachment": "leg" },
        { "name": "rightUpperArm", "bone": "R_Shoulder", "attachment": "rightUpperArm" },
        { "name": "rightLowerArm", "bone": "R_Elbow", "attachment": "rightLowerArm" },
        { "name": "torso", "bone": "Spine", "attachment": "torso" },
        { "name": "kilt", "bone": "Kilt", "attachment": "kilt" },
        { "name": "leftUpperArm", "bone": "L_Shoulder", "attachment": "leftUpperArm" },
        { "name": "leftLowerArm", "bone": "L_Elbow", "attachment": "leftLowerArm" },
        { "name": "head", "bone": "Head", "attachment": "head" },
        { "name": "spear", "bone": "R_Hand", "attachment": "spear" },
        { "name": "leftHand", "bone": "L_Hand", "attachment": "hand" },
        { "name": "rightHand", "bone": "R_Hand", "attachment": "hand" }
    ],
    "skins": {
        "default": {
            "head": {
                "head": { "x": 30.74, "y": 0.33, "rotation": -90.45, "width": 78, "height": 61 }
            },
            "kilt": {
                "kilt": { "x": 3.66, "y": -0.85, "rotation": 89.6, "width": 24, "height": 12 }
            },
            "leftHand": {
                "hand": { "x": 0.44, "y": -0.19, "rotation": 131.46, "width": 10, "height": 8 }
            },
            "leftLeg": {
                "leg": { "x": 6.39, "y": -0.25, "rotation": 92.97, "width": 8, "height": 14 }
            },
            "leftLowerArm": {
                "leftLowerArm": { "x": 4.95, "y": -0.09, "rotation": 109.97, "width": 10, "height": 12 }
            },
            "leftUpperArm": {
                "leftUpperArm": { "x": 2.66, "y": 0.16, "rotation": 49.52, "width": 14, "height": 12 }
            },
            "rightHand": {
                "hand": { "x": 0.85, "y": 0.11, "rotation": 99.24, "width": 10, "height": 8 }
            },
            "rightLeg": {
                "leg": { "x": 6.45, "y": -1.41, "rotation": 92.97, "width": 8, "height": 14 }
            },
            "rightLowerArm": {
                "rightLowerArm": { "x": 3.34, "y": -0.78, "rotation": 155.7, "width": 12, "height": 10 }
            },
            "rightUpperArm": {
                "rightUpperArm": { "x": 2.21, "y": 0.68, "rotation": 107.06, "width": 12, "height": 16 }
            },
            "spear": {
                "spear": { "x": 2.98, "y": -12.89, "rotation": 96.34, "width": 66, "height": 10 }
            },
            "torso": {
                "torso": { "x": 8.06, "y": 0.38, "rotation": -90, "width": 20, "height": 26 }
            }
        }
    },
    "animations": {
                    ...
                    "translate": [
                        {
                            ...
                            "x": 0,
                            "y": 0,
                            "curve": [0.25, 1, 0.316, 1]
                        },
                        {
                            "time": 0.3333,
                            "x": -3.62,
                            "y": 0,
                            "curve": [0.525, 0, 0.75, 1]
                        },
                        { "time": 1, "x": 0, "y": 0 }
                    ]
                },
